...
int YELLOW_TIME_IMAGE_RESOURCE_IDS[NUMBER_OF_TIME_IMAGES] = {
  RESOURCE_ID_YELLOW_IMAGE_TIME_0, 
  RESOURCE_ID_YELLOW_IMAGE_TIME_1, RESOURCE_ID_YELLOW_IMAGE_TIME_2, RESOURCE_ID_YELLOW_IMAGE_TIME_3, 
  RESOURCE_ID_YELLOW_IMAGE_TIME_4, RESOURCE_ID_YELLOW_IMAGE_TIME_5, RESOURCE_ID_YELLOW_IMAGE_TIME_6, 
  RESOURCE_ID_YELLOW_IMAGE_TIME_7, RESOURCE_ID_YELLOW_IMAGE_TIME_8, RESOURCE_ID_YELLOW_IMAGE_TIME_9
};
...
int YELLOW_DATE_IMAGE_RESOURCE_IDS[NUMBER_OF_DATE_IMAGES] = {
  RESOURCE_ID_YELLOW_IMAGE_DATE_0, 
  RESOURCE_ID_YELLOW_IMAGE_DATE_1, RESOURCE_ID_YELLOW_IMAGE_DATE_2, RESOURCE_ID_YELLOW_IMAGE_DATE_3, 
  RESOURCE_ID_YELLOW_IMAGE_DATE_4, RESOURCE_ID_YELLOW_IMAGE_DATE_5, RESOURCE_ID_YELLOW_IMAGE_DATE_6, 
  RESOURCE_ID_YELLOW_IMAGE_DATE_7, RESOURCE_ID_YELLOW_IMAGE_DATE_8, RESOURCE_ID_YELLOW_IMAGE_DATE_9
};
...
int YELLOW_SECOND_IMAGE_RESOURCE_IDS[NUMBER_OF_SECOND_IMAGES] = {
  RESOURCE_ID_YELLOW_IMAGE_SECOND_0, 
  RESOURCE_ID_YELLOW_IMAGE_SECOND_1, RESOURCE_ID_YELLOW_IMAGE_SECOND_2, RESOURCE_ID_YELLOW_IMAGE_SECOND_3, 
  RESOURCE_ID_YELLOW_IMAGE_SECOND_4, RESOURCE_ID_YELLOW_IMAGE_SECOND_5, RESOURCE_ID_YELLOW_IMAGE_SECOND_6, 
  RESOURCE_ID_YELLOW_IMAGE_SECOND_7, RESOURCE_ID_YELLOW_IMAGE_SECOND_8, RESOURCE_ID_YELLOW_IMAGE_SECOND_9
};
...
int YELLOW_DAY_IMAGE_RESOURCE_IDS[NUMBER_OF_DAY_IMAGES] = {
  RESOURCE_ID_YELLOW_IMAGE_DAY_0, RESOURCE_ID_YELLOW_IMAGE_DAY_1, RESOURCE_ID_YELLOW_IMAGE_DAY_2, 
  RESOURCE_ID_YELLOW_IMAGE_DAY_3, RESOURCE_ID_YELLOW_IMAGE_DAY_4, RESOURCE_ID_YELLOW_IMAGE_DAY_5, 
  RESOURCE_ID_YELLOW_IMAGE_DAY_6
};
...
void init() {
  ...
  switch (time_color_code) {   
    ...
    break;
    case 4:
    memcpy(TIME_IMAGE_RESOURCE_IDS, YELLOW_TIME_IMAGE_RESOURCE_IDS, sizeof TIME_IMAGE_RESOURCE_IDS);
    break;
    case 5:
  ...
  switch (date_color_code) { 
    ...
    break;
    case 4:
    memcpy(DATE_IMAGE_RESOURCE_IDS, YELLOW_DATE_IMAGE_RESOURCE_IDS, sizeof DATE_IMAGE_RESOURCE_IDS);
    break;
    case 5:
  ...
  switch (second_color_code) {     
    ...
    break;
    case 4:
    memcpy(SECOND_IMAGE_RESOURCE_IDS, YELLOW_SECOND_IMAGE_RESOURCE_IDS, sizeof SECOND_IMAGE_RESOURCE_IDS);
    break;
    case 5:
  ...
  switch (day_color_code) { 
    ...
    break;
    case 4:
    memcpy(DAY_IMAGE_RESOURCE_IDS, YELLOW_DAY_IMAGE_RESOURCE_IDS, sizeof DAY_IMAGE_RESOURCE_IDS);
    break;
    case 5:
